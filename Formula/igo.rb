...
class Igo < Formula
  ...
  if OS.mac?
    if Hardware::CPU.intel?
      url "https://github.com/fvrrvg/igo/releases/download/v0.1.0/igo-v0.1.0.darwin.amd64.tar.gz"
      sha256 "8c9e4537bb2c240b381e5c824376950d877f2cc77acad807625c5463ad008ebb"
    elsif Hardware::CPU.arm?
      url "https://github.com/fvrrvg/igo/releases/download/v0.1.0/igo-v0.1.0.darwin.arm64.tar.gz"
      sha256 "b64b1199e262adba0d642d64ee4af02ab3e966a7266aae270bdd301dc6ce558e"
    end
  elsif OS.linux?
    if Hardware::CPU.intel?
      url "https://github.com/fvrrvg/igo/releases/download/v0.1.0/igo-v0.1.0.linux.amd64.tar.gz"
